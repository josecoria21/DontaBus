-- Update save_routes_data to also upsert vehicle_type and image_url
...
BEGIN
  ...
  -- Upsert each route
  INSERT INTO routes (route_key, route_num, route_type, direction, name, vehicle_type, image_url)
  SELECT
    r->>'route_key',
    r->>'route_num',
    r->>'route_type',
